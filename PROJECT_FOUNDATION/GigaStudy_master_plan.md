...
- GigaStudy의 canonical visual direction은 `DESIGN/UI_DESIGN_DIRECTION.md`의 `Quiet Studio Console`을 따른다.
- 아래 View 기준은 기능 배치와 학습 흐름의 기준이고, 시각 톤과 화면 우선순위는 `DESIGN/UI_DESIGN_DIRECTION.md`를 함께 본다.
