...
7. Use `OPERATIONS/ALPHA_DEPLOYMENT_TARGET.md` as the current source of truth for the low-cost alpha stack, then close the remaining deployment blocker: one verified HTTPS staging environment.
