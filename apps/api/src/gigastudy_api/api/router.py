...
from gigastudy_api.api.routes.playback_instrument import router as playback_instrument_router
from gigastudy_api.api.routes.studios import router as studios_router

api_router = APIRouter()
api_router.include_router(health_router, tags=["health"])
api_router.include_router(playback_instrument_router, tags=["playback"])
